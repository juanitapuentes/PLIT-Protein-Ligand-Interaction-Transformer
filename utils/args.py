...
class ArgsInit(object):
    def __init__(self):
        ...
        parser.add_argument(
            "--batch_size", type=int, 
            default=1500, help="input batch size for training (default: 1500)",
        )
        parser.add_argument(
            "--feature", type=str,
        ...
        parser.add_argument(
            ...
            default="test",
            type=str,
            help="essay type {test, demo, train}",
        )
        parser.add_argument(
            "--molecule",
            default=None,
            type=str,
            help="Raw string of the Smiles representation of the molecule of interest.",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--epochs", type=int,
            default=200, help="number of epochs to train (default: 200)",
        )
        parser.add_argument(
            "--lr", type=float,
            default=1e-4, help="learning rate set for optimizer (default: 1e-4)"
        )
        parser.add_argument(
            "--dropout", type=float,
            default=0.1, help="Dropout rate layer (default: 0.1)"
        )
        # model
        parser.add_argument(
            "--num_layers",
        ...
        parser.add_argument("--save", type=str, default="TestResults", help="experiment name")
        ...
        # data partition
        parser.add_argument("--cross_val", type=int, default=1, help="Data partition")
        # Task
        parser.add_argument(
